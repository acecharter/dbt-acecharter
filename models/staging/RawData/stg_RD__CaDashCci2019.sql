SELECT
  ...
  prior_prep_cteplus_pct AS PriorPrepCtePlus_Pct,
  ...
  prior_aprep_summative_pct AS PriorAPrepSummative,
  prior_aprep_collegecredit AS PriorPrepCollegeCredit,
  prior_aprep_collegecredit_pct AS PriorPrepCollegeCreditPct,
  ...
  prior_aprep_milsci AS PriorPrepMilSci,
  prior_aprep_milsci_pct AS PriorPrepMilSciPct,
