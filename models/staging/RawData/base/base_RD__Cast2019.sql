SELECT 
  ...
  CAST(NULLIF(Total_Number_Tested_At_Entity_Level_and_Demographic, '*') AS INT64) AS TotalTestedAtEntityLevelAndDemographic,
  CAST(NULLIF(Total_Tested_at_this_Demographic_with_Valid_Scores, '*') AS INT64) AS TotalTestedAtThisDemographicWithValidScores,
