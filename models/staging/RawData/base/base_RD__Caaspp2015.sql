select
    ...
    cast(nullif(Area_1_Percentage_At_Or_Near_Standard, '*') as float64) as Area1PctNearStandard,
    ...
    cast(nullif(Area_2_Percentage_At_Or_Near_Standard, '*') as float64) as Area2PctNearStandard,
    ...
    cast(nullif(Area_3_Percentage_At_Or_Near_Standard, '*') as float64) as Area3PctNearStandard,
    ...
    cast(nullif(Area_4_Percentage_At_Or_Near_Standard, '*') as float64) as Area4PctNearStandard,
