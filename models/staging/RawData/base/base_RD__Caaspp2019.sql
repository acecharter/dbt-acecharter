SELECT 
    ...
    ROUND(CAST(NULLIF(Area_1_Percentage_Near_Standard, '*') AS FLOAT64)/100, 4) AS Area1PctNearStandard,
    ...
    ROUND(CAST(NULLIF(Area_2_Percentage_Near_Standard, '*') AS FLOAT64)/100, 4) AS Area2PctNearStandard,
    ...
    ROUND(CAST(NULLIF(Area_3_Percentage_Near_Standard, '*') AS FLOAT64)/100, 4) AS Area3PctNearStandard,
    ...
    ROUND(CAST(NULLIF(Area_4_Percentage_Near_Standard, '*') AS FLOAT64)/100, 4) AS Area4PctNearStandard,
