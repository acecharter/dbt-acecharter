...
WITH 
  caaspp_2015 AS (
    SELECT
      ...
      CAST(NULLIF(Area_1_Percentage_At_Or_Near_Standard, '*') AS FLOAT64) AS Area_1_Percentage_Near_Standard,
      ...
      CAST(NULLIF(Area_2_Percentage_At_Or_Near_Standard, '*') AS FLOAT64) AS Area_2_Percentage_Near_Standard,
      ...
      CAST(NULLIF(Area_3_Percentage_At_Or_Near_Standard, '*') AS FLOAT64) AS Area_3_Percentage_Near_Standard,
  ...
  caaspp_2017 AS (
    SELECT
      ...
      Grade,
      Test_Id,
      CAST(NULLIF(Students_Tested, '*') AS INT64) AS Students_Tested,
      CAST(NULLIF(Mean_Scale_Score, '*') AS FLOAT64) AS Mean_Scale_Score,
      CAST(NULLIF(Percentage_Standard_Exceeded, '*') AS FLOAT64) AS Percentage_Standard_Exceeded,
      CAST(NULLIF(Percentage_Standard_Met, '*') AS FLOAT64) AS Percentage_Standard_Met,
      CAST(NULLIF(Percentage_Standard_Met_and_Above, '*') AS FLOAT64) AS Percentage_Standard_Met_and_Above,
      ...
      CAST(NULLIF(Area_4_Percentage_Below_Standard, '*') AS FLOAT64) AS Area_4_Percentage_Below_Standard,
      CAST(NULL AS STRING) AS TypeId,
      CAST(NULLIF(Total_Tested_At_Entity_Level, '*') AS INT64) AS Total_Tested_At_Reporting_Level,
      CAST(NULLIF(Total_Tested_with_Scores, '*') AS INT64) AS Total_Tested_with_Scores_at_Reporting_Level,
      CAST(NULLIF(CAASPP_Reported_Enrollment, '*') AS INT64) AS Students_Enrolled
