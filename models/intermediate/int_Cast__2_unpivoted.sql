        ...
        * except (ReportingMethod),
        case
            when
                ...
                then 'Overall'
            when
                ReportingMethod like 'LifeSciences%'
                then 'Life Sciences Domain'
            when
                ReportingMethod like 'PhysicalSciences%'
                then 'Physical Sciences Domain'
            when
                ReportingMethod like 'EarthAndSpaceSciences%'
                then 'Earth and Space Sciences Domain'
